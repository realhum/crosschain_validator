...
ENV PYTHONUNBUFFERED=1 PYTHONDONTWRITEBYTECODE=1 POETRY_VIRTUALENVS_CREATE=0 SOURCE_DIR=/crosschain_backend WORK_DIR=/code ENTRYPOINT_SH_NAME=entrypoint_celery_worker.sh
